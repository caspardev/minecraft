...
import me.caspardev.enigma.event.events.Event3D;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        this.setupOverlayRendering();
        this.mc.ingameGUI.renderStreamIndicator(new ScaledResolution(Minecraft.getMinecraft(), Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight));
    }
