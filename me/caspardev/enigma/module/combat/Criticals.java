...
import me.caspardev.enigma.utils.PlayerUtils;
...
public class Criticals extends Module {
    ...
    public void setup() {
        ...
        Enigma.instance.settingsManager.rSetting(new Setting("Criticals Mode", this, "Packet", options));
    }

    @EventTarget
    public void onUpdate(EventUpdate event) {
        String mode = Enigma.instance.settingsManager.getSettingByName("Criticals Mode").getValString();
