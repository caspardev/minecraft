...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(Enigma.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New")){
		...
		}else if(Enigma.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = Enigma.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 : Enigma.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;;
